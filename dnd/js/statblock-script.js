...
const InternalToUi = Object.fromEntries(Object.entries(UiToInternal).map(([k, v]) => [v, k]));
                ...
                if (type != null && type != "error") {
                    ...
                    switch (type) {
                        ...
                        case "dmg":
                            ...
                            replaceString = Math.max(Math.floor(multiplier * ((dieSize + 1) / 2) + bonus), 1) + " (" + multiplier + "d" + die;
...
var FormFunctions = {
    ...
    SetForms: function () {
        ...
        $("#size-input").val(InternalToUi[mon.size] || mon.size);
...
var GetVariablesFunctions = {
    ...
    GetAllVariables: function () {
        ...
        let rawSize = $("#size-input").val();
        mon.size = (UiToInternal[rawSize] || rawSize).toLowerCase();
